...
import { TierPricingCard } from "@/components/payments/tier-pricing-card";
...
export function PaymentsTabs() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Payments"
        description="Set tier prices, review payment screenshots, and manage payment destinations."
      />
